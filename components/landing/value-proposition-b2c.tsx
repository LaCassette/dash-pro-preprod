...
import { Zap, Clock, Heart, Smartphone } from 'lucide-react';

const benefits = [
    {
        icon: Zap,
        title: 'IA Ultra-Personnalisée',
        description: 'Des programmes créés spécialement pour toi, qui évoluent avec tes progrès et s\'adaptent à ton rythme de vie.',
    ...
    },
    {
        ...
        description: 'Plus besoin de chercher des exercices ou des recettes. L\'app s\'occupe de tout, tu n\'as qu\'à suivre.',
    ...
    },
    {
        ...
        description: 'Défis quotidiens, badges à débloquer, suivi de progression... Tout est fait pour te garder motivé(e).',
    ...
    },
    {
        ...
        description: 'Ton coach personnel dans ta poche, disponible 24/7, où que tu sois, quand tu veux.',
        gradient: 'from-cyan-500/20 via-blue-500/15 to-violet-500/10',
        iconGradient: 'from-cyan-500 to-blue-500',
    },
];

export function ValuePropositionB2C() {
    return (
        <section className="relative bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 py-20 md:py-28 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="mx-auto max-w-3xl text-center mb-16">
                    ...
                    >
                        Oublie les Programmes Génériques
                    </h2>
                    <p className="text-xl text-slate-300" style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>
                        Une IA qui te <span className="text-violet-400 font-semibold">comprend vraiment</span> et s&apos;adapte à toi
                    </p>
                </div>
