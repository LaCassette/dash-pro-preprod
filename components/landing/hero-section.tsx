...
import { ArrowRight, Sparkles, Users, Star, Zap, Download } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';

const stats = [
  { icon: Users, value: "100+", label: "Utilisateurs" },
  { icon: Star, value: "4.8/5", label: "Note moyenne" },
  { icon: Download, value: "300+", label: "Téléchargements" },
          ...
          <div className="flex-1 text-center lg:text-left space-y-6">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-2">
              <Badge className="bg-gradient-to-r from-blue-500/20 via-violet-500/15 to-fuchsia-500/10 text-violet-300 border-violet-500/30 px-4 py-1.5 text-sm font-medium backdrop-blur-sm hover:bg-violet-500/20 transition-colors">
                ...
                Version 0.5.0 • Nouvelle mise à jour
              </Badge>
            </div>

            {/* Title with animated gradient - Using Playfair Display */}
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight" style={{ fontFamily: 'var(--font-playfair), Georgia, serif' }}>
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-xl mx-auto lg:mx-0 leading-relaxed" style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>
              Votre compagnon{' '}
              <span className="text-violet-400 font-semibold">IA</span> pour le
              <span className="text-white font-medium"> bien-être</span> et la
              <span className="text-white font-medium"> performance sportive</span>
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-green-500/20 to-emerald-500/10 rounded-lg blur-lg opacity-0 group-hover:opacity-100 transition-opacity" />
                <Image
